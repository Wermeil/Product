...
// ServerInterface represents all server transport.
...
// Registers transport, and prepends BaseURL to the paths, so that the paths
...
// StrictServerInterface represents all server transport.
